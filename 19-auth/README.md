...
- Discuss different encryption and hashing schemes, and `bcrypt` specifically
  - Do we want to ever store plaintext user passwords?(NOOOOO!!)
...
#### Authorization
- can't create a Drink unless logged in
- Can't delete a Drink unless logged in
- Create a UserDrink without having to select yourself
